    ...
    <>
      <motion.header
        ...
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          isScrolled
            ? 'py-3 bg-[#0A090F]/90 backdrop-blur-xl border-b border-white/10 shadow-2xl shadow-black/60'
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <a
            ...
            className="group focus:outline-none rounded-lg transition-transform active:scale-95"
          >
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-40 bg-[#0A090F]/98 backdrop-blur-3xl md:hidden pt-24 px-6 pb-8 flex flex-col justify-between overflow-y-auto"
          >
